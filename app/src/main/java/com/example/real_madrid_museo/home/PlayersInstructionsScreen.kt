...
@Composable
fun PlayersInstructionsScreen(onStart: () -> Unit, onBack: () -> Unit) {
        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.players_instructions_title),
                    ...
                    // INSTRUCCIÓN DESBLOQUEO (Proximidad)
                    InstructionItem(
                        icon = Icons.Default.PanTool,
                        title = stringResource(R.string.players_instructions_unlock_title),
                        desc = stringResource(R.string.players_instructions_unlock_desc)
                    )
                    
                    Spacer(modifier = Modifier.height(24.dp))

                    // INSTRUCCIÓN FICHA (Shake)
                    InstructionItem(
                        icon = Icons.Default.Vibration,
                        title = stringResource(R.string.players_instructions_shake_title),
                        desc = stringResource(R.string.players_instructions_shake_desc)
                    )

                    Spacer(modifier = Modifier.height(24.dp))

                    // INSTRUCCIÓN VÍDEO (Tilt)
                    InstructionItem(
                        icon = Icons.Default.ScreenRotation,
                        title = stringResource(R.string.players_instructions_tilt_title),
                        desc = stringResource(R.string.players_instructions_tilt_desc)
                    )
